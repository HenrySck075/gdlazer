...
void ScrollContainer::setContent(Container* content) {
  ...
  m_content->setAnchor(
    m_crossAxisAlignment == AxisAlignment::Start ? Anchor::TopLeft :
    m_crossAxisAlignment == AxisAlignment::Center ? (m_scrollDirection == ScrollDirection::Horizontal ? Anchor::Left : Anchor::Top) :
...
void ScrollContainer::setScrollDirection(
  ScrollDirection direction) {
  m_scrollDirection = direction;
}
void ScrollContainer::setCrossAxisAlignment(
